...
import {BetReach} from './betReach';
import {BetFlowGraph} from './betFlowGraph';
...
export class Profile extends React.Component{ 
    ...
    render(){
        ...
        return(            
            ...
            <Typography component="div" style={{ backgroundColor: "#28AE60", height: "150vh" }}>
                <Flexbox flexDirection="column" minHeight="100vh">
                    ...
                    <Flexbox flexGrow={1} justifyContent = 'center' alignItems = 'baseline'>
                    ...
                    <Flexbox flexGrow={3} justifyContent="center" alignItems="stretch">
                        <BetFlowGraph/>
                    </Flexbox>
